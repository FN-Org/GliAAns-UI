...
---------|------|--------|------
1 | 27/08/2025 | Federico G. Garau <br> Nicolò Trebino | first version of the document
2 | 26/11/2025 | Federico G. Garau <br> Nicolò Trebino | added class diagram
...
1. [a project description](#intro) 

2. [a detailed system overview with software architecture, data, and interfaces](#description)

3. [module-specific designs with diagrams and descriptions](#system-overview).

### <a name="biblio"></a> 1.4 Bibliography
- [Document References](./../ref/res)
- [Pediatric FDOPA Pipeline GitHub Repository](https://github.com/MicheleMureddu/Pediatric_fdopa_pipeline)
- [A New Tool for Extracting Static and Dynamic Parameters from \[18F\]F-DOPA PET/CT in Pediatric Gliomas](https://www.mdpi.com/2077-0383/13/20/6252#)
...
#### Assumption:
- The user is a medical professional who is required to have an in-depth knowledge of the pertinent field.

## <a name="system-overview"></a>  3 System Overview
In this section is shown the Use Case Model of the system:

![use cases diagram](./imgs/use_cases_diagram.png)
...
For the class description, check out the [docs](./../../src/pdoc/docs/index.html)
